...
@Component({
  selector: 'app-masterbracket133',
  templateUrl: './masterbracket133.component.html',
  styleUrls: ['./masterbracket133.component.scss']
})
export class Masterbracket133Component implements OnInit {
